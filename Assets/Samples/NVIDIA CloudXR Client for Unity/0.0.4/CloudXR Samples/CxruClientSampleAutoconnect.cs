...
public class CxruClientSampleAutoconnect : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        cxrManager.SetUnityResolutionScaling(urpAsset.renderScale);
        UpdatePlatform();
    ...
    private void OnCxrStatusChange(object sender, CloudXRManager.StatusChangeArgs e)
    {
    ...
    private IEnumerator LoadIpAdress()
    {
        while (!doConnect)
        {
